...
class ScheduleExceptionService {
  ...
  async getMyScheduleExceptions(
    ...
    return this.request<ScheduleExceptionsResponse>(
      `doctors/me/schedule-exceptions?${searchParams.toString()}`,
      { headers },
    );
  }
  ...
  async getScheduleExceptionById(id: string, token: string): Promise<ScheduleException> {
    ...
    return this.request<ScheduleException>(`doctors/me/schedule-exceptions/${id}`, { headers });
  }
  ...
  async createScheduleException(
    ...
    return this.request<ScheduleException>('doctors/me/schedule-exceptions', {
      method: 'POST',
      headers,
  ...
  async updateScheduleException(
    ...
    return this.request<ScheduleException>(`doctors/me/schedule-exceptions/${id}`, {
      method: 'PUT',
      headers,
      body: JSON.stringify(formattedData),
    });
  ...
  async deleteScheduleException(id: string, token: string): Promise<void> {
    ...
    await this.request(`doctors/me/schedule-exceptions/${id}`, {
      method: 'DELETE',
      headers,
    });
  }
